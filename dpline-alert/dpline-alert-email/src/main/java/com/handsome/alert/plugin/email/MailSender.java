package com.handsome.alert.plugin.email;

import com.handsome.alert.plugin.email.template.AlertTemplate;
import com.sun.mail.smtp.SMTPProvider;
import org.apache.commons.collections.CollectionUtils;
import org.apache.commons.mail.EmailException;
import org.apache.commons.mail.HtmlEmail;
import com.handsome.alert.api.AlertConstants;
import com.handsome.alert.api.AlertResult;
import com.handsome.alert.api.ShowType;
import com.handsome.alert.plugin.email.exception.AlertEmailException;
import com.handsome.alert.plugin.email.template.DefaultHTMLTemplate;
...
public final class MailSender {
    ...
    private void attachContent(String title, String content, String partContent, MimeMessage msg) throws MessagingException, IOException {
        ...
        String fileName = title + EmailConstants.EXCEL_SUFFIX_XLSX;
        String filePath = xlsFilePath + EmailConstants.SINGLE_SLASH + fileName;
        ...
        part2.setFileName(MimeUtility.encodeText(fileName, EmailConstants.UTF_8, "B"));
