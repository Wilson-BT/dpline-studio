...
import com.handsome.common.util.CollectionUtils;
...
public enum ExecStatus {
    ...
    public static List<Integer> runningArray() {
        ArrayList<Integer> integers = new ArrayList<>();
        integers.add(RUNNING.getCode());
        integers.add(SUBMITTING.getCode());
        integers.add(CANCELLING.getCode());
        integers.add(STOPPING.getCode());
        integers.add(INITIALIZING.getCode());
        integers.add(FAILING.getCode());
        return integers;
    }
