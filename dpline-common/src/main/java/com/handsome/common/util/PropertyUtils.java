...
import static com.handsome.common.Constants.COMMON_PROPERTIES_PATH;
...
public class PropertyUtils {
    ...
    public static boolean getResRemoteType(){
        String upperCaseString = PropertyUtils.getUpperCaseString(Constants.RESOURCE_STORAGE_TYPE);
