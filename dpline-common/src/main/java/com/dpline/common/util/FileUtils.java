...
//    public static final String DATA_BASEDIR = PropertyUtils.getProperty(DATA_BASEDIR_PATH, "/tmp/dpline");
    ...
    public static String concatPath(String directory, String path) {
        return Paths.get(directory, path).toString();
    }

    public static void main(String[] args) {
//        writeContent2File("","/tmp/dpline/logs/9640278031136/deploy/10136815761696.log");
        String s = concatPath("C:\\Users\\wangchunshun\\Desktop\\Document\\flink-1.16.3", "lib");
