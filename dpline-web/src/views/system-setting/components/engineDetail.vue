        ...
        },
        {
          ...
          customRender: (text, record) => {
            return {
              ...
              }, record.env == '测试环境' ? record.uatClusterName : record.clusterName)
            }
          }
        },
        {
          ...
          customRender: (text, record) => {
            return {
              ...
              }, record.env == '测试环境' ? record.uatEngineQueue : record.engineQueue)
            }
          }
        },
      ]
        ...
        },
        {
          ...
          customRender: (text, record) => {
            return {
              ...
              }, record.env == '测试环境' ? record.uatNamespace : record.namespace)
            }
          }
        },
      ]
