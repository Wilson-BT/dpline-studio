    ...
    methods: {
      init () {
        ...
        if (query.projectId) {//存储当前项目信息
          ...
          if (applicationNames.includes(this.$route.name) && (query.projectId !== this.$store.getters.currentProject.id || query.projectName !== this.$store.getters.currentProject.name)) {
