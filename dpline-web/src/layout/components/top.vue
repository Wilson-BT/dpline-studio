  ...
  <div class="header-container">
    <div class="left">
      ...
      <div class="logo-container justify-start">
        <img src="@/assets/icons/top-logo.png"
             alt="">
        <div>DPLINE实时计算平台</div>
      </div>
      <div v-if="showProject"
           class="project-container justify-start">
      ...
      <div class="action-container">
        <el-dropdown trigger="click"
          ...
          <div class="action-wrap">
            ...
            <i :class="iconClass"
               class="login-user-dropdown-icon"></i>
          </div>
  ...
  export default {
    ...
    data () {
      return {
        ...
        //   { label: "测试环境", value: "test", color: "#25CBCE" },
    ...
    methods: {
      ...
      //         const { projectName, projectCode } = this.$route.params;
      //         query = {
      //           projectId,
      //         };
      //         params = {
      ...
      handleSelectChange (value) {
        ...
        if (findItem && findItem.length) {
          ...
          if (this.$route.name === "SourceManage_allVersion") {
            name = "SourceManage";
          }
          this.$router.push({
            name: name,
