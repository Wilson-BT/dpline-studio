...
if (process.env.NODE_ENV === 'production') {// 判断当前是什么环境, 如果是开发环境就用.env.development文件的配置，如果是生产环境就用拼接方式
  config.socketHost = window.document.location.host
}
...
// import socketJs from "@/plugin/socket";
import '@/mock/index'
