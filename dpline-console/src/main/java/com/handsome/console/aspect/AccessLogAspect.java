package com.handsome.console.aspect;
...
public class AccessLogAspect {
    ...
    @Pointcut("@annotation(com.handsome.console.aspect.AccessLogAnnotation)")
    ...
    public Object doAround(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        com.handsome.console.aspect.AccessLogAnnotation annotation = method.getAnnotation(com.handsome.console.aspect.AccessLogAnnotation.class);
     ...
     * @return
     */
    private String parseArgs(ProceedingJoinPoint proceedingJoinPoint, com.handsome.console.aspect.AccessLogAnnotation annotation) {
