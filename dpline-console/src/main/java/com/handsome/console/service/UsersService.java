...
public interface UsersService {
    ...
    Map<String, Object> createUser(User loginUser, String userName, String userPassword, String email,
                                   String phone, int state,int isAdmin) throws IOException;

    User createUser(String userName, String userPassword, String email,
                    String phone, int state,int isAdmin);

    /***
     * create User for ldap login
     */
    User createUser(UserType userType, String userName, String email, int isAdmin);
     ...
     * @return user info
     */
    User queryUser(String userCode, String password);
...
//    Map<String, Object> grantDataSource(User loginUser, int userId, String datasourceIds);
     ...
     * @throws Exception exception
     */
    Map<String, Object> registerUser(String userName, String userPassword, String repeatPassword, String email,int isAdmin);
    ...
    Map<String, Object> grantK8sNameSpaces(User loginUser, int userId, String k8sNameSpaceIds);
