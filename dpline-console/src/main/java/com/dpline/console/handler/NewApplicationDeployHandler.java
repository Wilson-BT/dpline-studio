...
/**
 */
public class NewApplicationDeployHandler implements NewDeployHandler {

    private final FsStore fsStore;
    private final AbstractDeployConfig deployConfig;
    private final static Logger logger = LoggerFactory.getLogger(NewApplicationDeployHandler.class);

    public NewApplicationDeployHandler(FsStore fsStore,AbstractDeployConfig deployConfig) {
    ...
    private void copyMainFile(FlinkDeployConfig flinkDeployConfig) throws Exception {
        ...
        logger.info("Main jar => [{}] has been copy success", mainJar.getJarPath());
    }
