...
--
-- Table structure for table `dpline_alert_instance`
--
...
--
-- Table structure for table `dpline_cluster`
--
...
--
-- Table structure for table `dpline_cluster_user`
--
...
--
-- Table structure for table `dpline_data_source`
--
...
--
-- Table structure for table `dpline_docker_image`
--
...
--
-- Table structure for table `dpline_file`
--
...
CREATE TABLE `dpline_file` (
                               ...
                               `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
                               PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11057910691617 DEFAULT CHARSET=utf8mb4 COMMENT='文件';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `dpline_file_tag`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=11058120434849 DEFAULT CHARSET=utf8mb4 COMMENT='tag 标记';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `dpline_flink_session`
--
...
--
-- Table structure for table `dpline_flink_tag_task_res_relation`
--
...
--
-- Table structure for table `dpline_flink_tag_task_udf_relation`
--
...
--
-- Table structure for table `dpline_flink_version`
--
...
--
-- Table structure for table `dpline_folder`
--
...
CREATE TABLE `dpline_folder` (
                                 ...
                                 `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
                                 PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10832699886753 DEFAULT CHARSET=utf8mb4 COMMENT='目录';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `dpline_jar_file_dtl`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=11498054542625 DEFAULT CHARSET=utf8mb4 COMMENT='jar包资源管理';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `dpline_job`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=11058121953185 DEFAULT CHARSET=utf8mb4 COMMENT='作业';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `dpline_job_alert_record`
--

DROP TABLE IF EXISTS `dpline_job_alert_record`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dpline_job_alert_record` (
                                           `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                           `job_id` bigint(20) NOT NULL COMMENT 'ID',
                                           `rule_id` bigint(20) NOT NULL COMMENT 'ID',
                                           `alert_time` datetime NOT NULL,
                                           `alert_content` varchar(1000) NOT NULL,
                                           `alert_num` int(4) DEFAULT NULL,
...
--
-- Table structure for table `dpline_job_alert_rule`
--

DROP TABLE IF EXISTS `dpline_job_alert_rule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dpline_job_alert_rule` (
                                         `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                         `job_id` bigint(20) NOT NULL COMMENT 'ID',
                                         `rule_generate_type` varchar(40) NOT NULL,
                                         `rule_name` varchar(128) NOT NULL,
                                         `rule_desc` varchar(255) NOT NULL,
                                         `index_name` varchar(128) DEFAULT NULL,
                                         `rule_content` varchar(255) NOT NULL,
                                         `effective_time` varchar(40) NOT NULL COMMENT '00:00-10:00',
                                         `alert_rate` int(11) NOT NULL COMMENT '()',
                                         `notify_type` varchar(255) DEFAULT NULL,
                                         `notify_users` varchar(800) NOT NULL,
                                         `effective_state` varchar(40) NOT NULL,
                                         `enabled_flag` tinyint(4) NOT NULL,
                                         `create_user` varchar(128) DEFAULT NULL,
                                         `update_user` varchar(128) DEFAULT NULL,
                                         `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
...
) ENGINE=InnoDB AUTO_INCREMENT=8004 DEFAULT CHARSET=utf8mb4 COMMENT='job';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `dpline_job_operate_log`
--
...
--
-- Table structure for table `dpline_job_savepoint`
--
...
--
-- Table structure for table `dpline_main_resource`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=11276119989537 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `dpline_project`
--
...
--
-- Table structure for table `dpline_project_user`
--
...
--
-- Table structure for table `dpline_session`
--
...
--
-- Table structure for table `dpline_sys_config`
--
...
--
-- Table structure for table `dpline_udfs`
--
...
--
-- Table structure for table `dpline_user`
--
