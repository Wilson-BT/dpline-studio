...
//    private ClusterSpecification clusterSpecification;
    ...
    public void setSpecialConfig(Configuration configuration, FlinkSubmitRequest submitRequest) {
        // 镜像拉取模式
        FlinkK8sRemoteSubmitRequest flinkSubmitRequest = (FlinkK8sRemoteSubmitRequest) submitRequest;
        K8sOptions k8sOptions = flinkSubmitRequest.getK8sOptions();
        // resource 资源设置
        RuntimeOptions resourceOptions = flinkSubmitRequest.getRuntimeOptions();
        // 始终拉取镜像写死
