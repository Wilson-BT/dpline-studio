...
public class SqlSplitter {
     ...
     * @return
     */
    public static List<String> splitSql(String text) {
    ...
    private static String createEmptyLine(String text) {
...
//        String sql = "select * from dadaf select * from";
//        List<String> strings = splitSql(sql);
