...
import org.apache.doris.shaded.com.fasterxml.jackson.databind.type.CollectionType;
...
import static org.apache.doris.shaded.com.fasterxml.jackson.databind.DeserializationFeature.*;
import static org.apache.doris.shaded.com.fasterxml.jackson.databind.MapperFeature.REQUIRE_SETTERS_FOR_GETTERS;
...
public class JSONUtils {
    ...
    public static String toBeautifulString(Object object){
        try {
    ...
    public static String formatToBeautifulString(String str){
        try {
            ObjectWriter writer = objectMapper.writerWithDefaultPrettyPrinter();
            return writer.writeValueAsString(parseObject(str));
        } catch (Exception e) {
            logger.error("object to json exception!", e);
        }
        return null;
