...
public abstract class AbstractConfigSetting {
    ...
    private Configuration loadConfiguration() {
        this.configuration = GlobalConfiguration.loadConfiguration(submitRequest.getFlinkHomeOptions().getFlinkPath() + "/conf");
        if (!configuration.contains(DeploymentOptionsInternal.CONF_DIR)) {
            configuration.set(DeploymentOptionsInternal.CONF_DIR, submitRequest.getFlinkHomeOptions().getFlinkPath() + "/conf");
        }
        return this.configuration;
    }
